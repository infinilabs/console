# INFINI Console - Bug and Issue Tracker

## The issue list

Head straight to https://github.com/infinilabs/console/issues for a list of all issues or click `Issues` in the navigation bar on the almost-top.
...
- **This tracker is for issues with the INFINI Console only.**

- Search for the issue [here](https://github.com/infinilabs/console/search?q=&type=Issues) or the disucssions [here](https://github.com/infinilabs/console/discussions) to check if it was already reported. You may use labels for filtering the [issue list](https://github.com/infinilabs/console/issues) by clicking any of these related to the problem you want to report or request.
...
- Then, **describe** the bug with all the information you can give.
  ...
  - Operating System
  - The version of INFINI Console that you're using
  - Any related configuration which may cause console to act strangely

  Also keep in mind to clearly separate fact from speculation.

- Try to find a way to **reproduce** the problem and write down precise steps. It might be useful to include a _configuration example_ for this.
...
Thanks for using INFINI Console.
