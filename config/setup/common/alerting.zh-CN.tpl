...
POST $[[SETUP_INDEX_PREFIX]]alert-rule/$[[SETUP_DOC_TYPE]]/builtin-cm4z6m5fv8l0qk2p9x7r
{
  "id": "builtin-cm4z6m5fv8l0qk2p9x7r",
  ...
  "resource": {
    ...
    "raw_filter": {
      "match_phrase": {
        "labels.health_status": "unavailable"
      }
    },
    "ignore_time_filter": true,
    "time_field": "updated",
  ...
  "metrics": {
    ...
    "expression": "count(labels.health_status)"
  },
  "conditions": {
    "operator": "any",
    "items": [
