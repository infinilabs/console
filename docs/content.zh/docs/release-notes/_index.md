...
### 🐛 Bug fix  
### ✈️ Improvements  
- 此版本包含了底层 [Framework v1.1.8](https://docs.infinilabs.com/framework/v1.1.8) 的更新，解决了一些常见问题，并增强了整体稳定性和性能。虽然 CONSOLE 本身没有直接的变更，但从 Framework 中继承的改进间接地使 CONSOLE 受益。
