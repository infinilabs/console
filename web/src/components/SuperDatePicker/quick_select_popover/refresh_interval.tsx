...
import { EuiButton, EuiFieldNumber, EuiFlexGroup, EuiFlexItem, EuiI18n, EuiScreenReaderOnly, EuiSelect, EuiSpacer, EuiTitle, htmlIdGenerator, RelativeOption, TimeUnitId } from '@elastic/eui';
import { ApplyRefreshInterval, Milliseconds } from '@elastic/eui/src/components/date_picker/types';
import React, {
  Component,
  ChangeEventHandler,
