    ...
    if (
      ...
      const toast = notifications!.toasts.addWarning({
        ...
        text: toMountPoint(
          <div>
            <p>
              It looks like you may be trying to use Lucene query syntax, although you
               have Kibana Query Language (KQL) selected. Please review the KQL docs <EuiLink href={kueryQuerySyntaxLink} target="_blank">
                      here
                    </EuiLink>.
            </p>
