            ...
            append={
              bucketInterval.scaled ? (
                <EuiIconTip
                  ...
                  content={
                    `This interval creates ${bucketInterval!.scale && bucketInterval!.scale > 1
                      ? 'buckets that are too large'
                      : 'too many buckets'} to show in the selected time range, so it has been scaled to ${bucketInterval.description}.`
                  }
                  color="warning"
                  size="s"
                  type="alert"
