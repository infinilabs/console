...
export {IndexPattern, IndexPatternField, DuplicateIndexPatternError } from '../../data/common';
export type Query = {
...
/* start  field_wildcard(kibana_utils/public */
...
} from '../../kibana_utils/public/state_sync';
...
export function createStateContainer(
  ...
  const container = {
    ...
    reducer: (state, action) => {
      ...
      const pureTransition = pureTransitions[
        action.type
      ];
...
/* end  field_wildcard(kibana_utils/public */