...
const indexPatternTypeName ='index pattern';

const indexPatternButtonText = 'Standard index pattern';

const indexPatternButtonDescription =  'Perform full aggregations against any data';
