...
const API_BASE_URL: string = `/view/`;
...
export class IndexPatternsApiClient implements IIndexPatternsApiClient {
  ...
  private _request(url: string, query: any) {
    return this.http
      ...
      .catch((resp: any) => {
        if (
          resp.body.statusCode === 404 &&
          resp.body.attributes?.code === "no_matching_indices"
        ) {
