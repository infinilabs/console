...
export const onUnsupportedTimePattern = (
  ...
  const warningTitle = "Support for time interval index patterns removed";

  const warningText = `Currently querying all indices matching ${index}. ${title} should be migrated to a wildcard-based index pattern.`;
