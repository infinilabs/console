...
const connectToQueryGlobalState = (
  query: QueryStart,
  state: BaseStateContainer<QueryState>
) =>
...
describe("connect_to_global_state", () => {
  ...
  beforeEach(() => {
    ...
    filterManagerChangeSub = filterManager
      .getUpdates$()
      .subscribe(filterManagerChangeTriggered);
