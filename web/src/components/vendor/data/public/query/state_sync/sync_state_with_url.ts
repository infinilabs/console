...
export const syncQueryStateWithUrl = (
  query: Pick<
    ...
    "filterManager" | "timefilter" | "queryString" | "state$"
  >,
  ...
  const initialStateFromUrl = kbnUrlStateStorage.get<QueryState>(
  ...
  const stopSyncingWithStateContainer = connectToQueryState(
    query,
