...
export { TimefilterService,  } from './timefilter_service';//TimefilterSetup

export * from './types';
export { Timefilter,  } from './timefilter'; //TimefilterContract
export { TimeHistory,  } from './time_history'; //TimeHistoryContract
