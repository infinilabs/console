 ...
 */
export class PhraseSuggestorUI<
  T extends PhraseSuggestorProps
> extends React.Component<T, PhraseSuggestorState> {
  ...
  protected isSuggestingValues() {
    const shouldSuggestValues = true;
    // this.services.uiSettings.get(
