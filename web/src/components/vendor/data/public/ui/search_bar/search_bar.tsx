  ...
  */
  ...
  public setFilterBarHeight = () => {
    requestAnimationFrame(() => {
      const height =
        this.filterBarRef && this.state.isFiltersVisible
  ...
  public render() {
    const savedQueryManagement = this.state.query &&
    ...
    if (this.shouldRenderQueryBar()) {
      queryBar = (
        <QueryBarTopRow
          ...
          histogramOpts={this.props.histogramOpts}
    ...
    return (
      <div className="globalQueryBar" data-test-subj="globalQueryBar">
        <div style={{ display: 'flex'}}>
          {
            this.props.selectedIndexPattern && (
              <EuiFlexItem style={{margin: '0px 8px 0px 0'}}>
                <IndexPatternSelect
                  selectedIndexPattern={this.props.selectedIndexPattern}
                  onIndexPatternChange={this.props.setIndexPattern}
                  views={this.props.indexPatternList}
                  indices={this.props.indices}
                />
              </EuiFlexItem>
            )
          }
          <div style={{ flex: 1}}>{queryBar}</div>
        </div>
        {filterBar}
          ...
          <SaveQueryForm
            savedQuery={
              this.props.savedQuery
                ? this.props.savedQuery.attributes
                : undefined
            }
            savedQueryService={this.savedQueryService}
            onSave={this.onSave}
