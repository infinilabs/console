...
//
// @public
export const castEsToKbnFieldTypeName: (
  esType: ES_FIELD_TYPES | string
) => KBN_FIELD_TYPES;
...
// @internal
export function getTotalLoaded({
  total,
  failed,
  successful,
}: ShardsResponse): {
...
export interface IEsSearchRequest
  extends IKibanaSearchRequest<ISearchRequestParams> {
  // (undocumented)
  indexType?: string;
}
...
//
// @public (undocumented)
export type IEsSearchResponse<Source = any> = IKibanaSearchResponse<
...
export class IndexPatternsService
  implements Plugin_3<void, IndexPatternsServiceStart> {
  // (undocumented)
  ...
  start(
    ...
    indexPatternsServiceFactory: (
      kibanaRequest: KibanaRequest_2
    ) => Promise<IndexPatternsService_2>;
  };
}
...
export class Plugin
  ...
  // (undocumented)
  setup(
    core: CoreSetup<DataPluginStartDependencies, PluginStart>,
    ...
    fieldFormats: {
      register: (
        customFieldFormat: import("../public").FieldFormatInstanceType
      ) => number;
    };
  };
  // (undocumented)
  start(
    ...
    fieldFormats: {
      fieldFormatServiceFactory: (
        uiSettings: import("../../../core/server").IUiSettingsClient
      ) => Promise<import("../common").FieldFormatsRegistry>;
    };
    indexPatterns: {
      indexPatternsServiceFactory: (
        kibanaRequest: import("../../../core/server").KibanaRequest<
          unknown,
          unknown,
          unknown,
          any
    ...
    search: ISearchStart<
      import("./search").IEsSearchRequest,
      import("./search").IEsSearchResponse<any>
    >;
  };
  // (undocumented)
  stop(): void;
  ...
  aggs: {
    ...
    intervalOptions: (
      | {
          ...
          val: string;
          enabled(
            agg: import("../common").IBucketAggConfig
          ): boolean | "" | undefined;
        }
      | {
          display: string;
    ...
    isType: (
      ...types: string[]
    ) => (agg: import("../common").AggConfig) => boolean;
