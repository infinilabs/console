...
import { FieldIcon, FieldIconProps } from "../../../../../react/public";
...
export function FieldName({
  ...
  const displayName = useShortDots ? abbreviate(fieldName, 38) : fieldName; //shortenDottedString(fieldName) : fieldName;
