...
export function ChangeIndexPattern({
    ...
    return (
      <Button
        ...
        style={{ 
          ...
          border: 0,
          background: '#fbfcfd',
          boxShadow: '0 1px 1px -1px rgba(152,162,179,0.2), 0 3px 2px -2px rgba(152,162,179,0.2), inset 0 0 0 1px rgba(15,39,118,0.1)' 
        }}
      >
        <div style={{
          width: 180,
  ...
  const tabs = React.useMemo(() => {
    ...
    const tabs = [
      {
        id: "view",
        name: formatMessage({ id: "explore.datatype.view" }),
        disabled: false,
        content: (
          <EuiSelectable
            style={{ marginTop: 10 }}
      ...
      {
        id: "index",
        name: formatMessage({ id: "explore.datatype.index" }),
        disabled: false,
        content: (
          <div>
            <div
