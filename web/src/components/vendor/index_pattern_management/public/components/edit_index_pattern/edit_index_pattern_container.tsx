...
const EditIndexPatternCont: React.FC<RouteComponentProps<{ id: string }>> = ({
  ...props
}) => {
  ...
  if (indexPattern) {
    return (
      <EditIndexPattern selectedCluster={props.selectedCluster} indexPattern={indexPattern} id={indexPattern.id} />
    );
  } else {
    return <></>;
  }
