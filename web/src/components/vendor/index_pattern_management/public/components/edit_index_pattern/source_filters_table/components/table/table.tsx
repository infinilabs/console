...
const filterDescription = 'Filter name';

const matchesHeader = 'Matches';

const matchesDescription = 'Language used for the field';

const editAria = 'Edit';

const saveAria = 'Save';

const deleteAria = 'Delete';

const cancelAria =  'Cancel';
