    ...
    <EuiFlyout onClose={onClose}>
      <EuiFlyoutBody>
        <EuiText>
          ...
          <p>
            If the URL in this field is large, it might be useful to provide an alternate template for the text version
              of the URL. This will be displayed instead of the url, but will still link to the URL. The format is a string which uses
              double curly brace notation <EuiCode>{'{{ }}'}</EuiCode> to inject values. The following values can be accessed:
          </p>
          <ul>
            <li>
