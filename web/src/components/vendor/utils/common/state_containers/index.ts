 ...
 * Refer to {@link https://github.com/elastic/kibana/tree/master/src/plugins/utils/docs/state_containers | guides and examples} for more info
 *
...
export { createStateContainer } from "./create_state_container"; //CreateStateContainerOptions
export {
