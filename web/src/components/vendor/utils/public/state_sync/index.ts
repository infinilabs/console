 ...
 *
 * They are designed to work together with {@link https://github.com/elastic/kibana/tree/master/src/plugins/utils/docs/state_containers | state containers}. But state containers are not required.
 *
 ...
 *
 * Refer {@link https://github.com/elastic/kibana/tree/master/src/plugins/utils/docs/state_sync | here} for a complete guide and examples.
...
export { syncState, syncStates } from // StopSyncStateFnType,
