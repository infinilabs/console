...
export default {
  ...
  "system.security.token.drawer.create.title": "Create API Token",
  "system.security.token.drawer.edit.title": "Edit API Token",
  "system.security.token.create.result.title": "API Token Created",
