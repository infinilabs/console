...
export default {
  ...
  "system.security.tab.token": "Access Credential",
  "system.security.token.table.token": "Access Credential",
  "system.security.token.search.placeholder": "Type keyword to search",
  "system.security.token.table.name": "Name",
  "system.security.token.table.description": "Description",
  "system.security.token.table.permissions": "Permissions",
  "system.security.token.table.expire": "Expire At",
  "system.security.token.never_expire": "Never",
  "system.security.token.form.name": "Name",
  "system.security.token.form.name.required": "Please input token name!",
  "system.security.token.form.description": "Description",
  "system.security.token.form.expire": "Expire At",
  "system.security.token.form.expire.required": "Please select an expiration time!",
  "system.security.token.form.expire.future": "Expiration time must be in the future!",
  "system.security.token.form.never_expire": "Never expire",
  "system.security.token.drawer.create.title": "Create Access Credential",
  "system.security.token.drawer.edit.title": "Edit Access Credential",
  "system.security.token.create.result.title": "Access Credential Created",
  "system.security.token.create.result.tip":
    "Please copy and store this token now. It will only be shown once.",
  "system.security.token.copy.tooltip": "Copy",
  "system.security.token.copy.success": "Access credential copied to clipboard",
  "system.security.token.copy.failed": "Failed to copy access credential",
  ...
  "system.security.user.table.status": "Status",
