...
export default {
  ...
  "system.security.tab.token": "访问凭据",
  "system.security.token.table.token": "访问凭据",
  "system.security.token.search.placeholder": "输入关键字搜索",
  "system.security.token.table.name": "名称",
  "system.security.token.table.description": "描述",
  "system.security.token.table.permissions": "权限",
  "system.security.token.table.expire": "过期时间",
  "system.security.token.never_expire": "永不过期",
  "system.security.token.form.name": "名称",
  "system.security.token.form.name.required": "请输入 Token 名称！",
  "system.security.token.form.description": "描述",
  "system.security.token.form.expire": "有效期至",
  "system.security.token.form.expire.required": "请选择有效期！",
  "system.security.token.form.expire.future": "有效期必须晚于当前时间！",
  "system.security.token.form.never_expire": "永不过期",
  "system.security.token.drawer.create.title": "创建访问凭据",
  "system.security.token.drawer.edit.title": "编辑访问凭据",
  "system.security.token.create.result.title": "访问凭据已创建",
  "system.security.token.create.result.tip":
    "请立即复制并妥善保存该 Token。该值只会展示一次。",
  "system.security.token.copy.tooltip": "复制",
  "system.security.token.copy.success": "访问凭据已复制到剪贴板",
  "system.security.token.copy.failed": "访问凭据复制失败",
  ...
  "system.security.user.table.status": "状态",
