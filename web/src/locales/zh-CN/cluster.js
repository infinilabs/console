export default {
  ...
  "cluster.manage.monitoring.enable.action": "启用监控",
  "cluster.manage.monitoring.disable.action": "禁用监控",
  "cluster.manage.monitoring.confirm.enable.title": "确认启用这个集群的监控吗？",
  "cluster.manage.monitoring.confirm.disable.title": "确认禁用这个集群的监控吗？",
  "cluster.manage.monitoring.confirm.cluster": "集群：{name}",
  "cluster.manage.monitoring.confirm.version": "版本：{version}",
  "cluster.manage.monitoring.confirm.endpoint": "地址：{endpoint}",
  ...
  "cluster.manage.delete.confirm.endpoint": "地址：{endpoint}",
  ...
  "cluster.manage.agent_credential.placeholder.auto_create": "留空将自动创建，失败时回退使用平台凭据",
  "cluster.manage.agent_credential.tip.agentless_skip": "当前为非探针采集模式，无需配置探针凭据；如需通过 Agent 采集指标和日志，请先切换为探针模式。",
  "cluster.manage.agent_logs_paths.label": "探针日志采集路径",
  "cluster.manage.agent_logs_paths.placeholder": "请输入一个或多个日志目录",
  "cluster.manage.agent_logs_paths.tips": "这里配置的是该集群默认的 Agent 日志采集目录，会用于后续批量关联和自动补关联的新节点；留空则继续使用节点自身探测到的 path.logs。",
  "cluster.manage.config_item.enabled": "启用",
  "cluster.manage.config_item.interval": "间隔",
  "cluster.manage.config_item.interval.unit": "秒",
  "cluster.manage.monitor_configs.cluster_health": "集群健康状态指标",
  "cluster.manage.monitor_configs.cluster_stats": "集群指标",
  "cluster.manage.monitor_configs.tips.cluster_health": "采集集群健康状态（green/yellow/red）等概览指标。",
  "cluster.manage.monitor_configs.tips.cluster_stats": "采集 _cluster/stats 的集群级统计信息（节点数、分片、存储等）。",
  "cluster.manage.monitor_configs.node_stats": "节点指标",
  "cluster.manage.monitor_configs.tips.node_stats": "采集 _nodes/stats 的各节点统计信息（CPU、内存、磁盘、线程池等）。",
  "cluster.manage.monitor_configs.index_stats": "索引指标",
  "cluster.manage.monitor_configs.tips.index_stats": "采集 _stats 的各索引统计信息（文档数、大小、分段、合并等）。",
  ...
  "cluster.manage.metadata_configs.tips.health_check": "定时检查集群健康与可达性，用于更新集群可用状态。",
  "cluster.manage.metadata_configs.tips.node_availability_check": "基于 TCP 对节点地址做可用性探测，需要直接访问节点；当集群仅能通过 HTTP 代理访问时将无法工作。",
  "cluster.manage.metadata_configs.tips.metadata_refresh": "定时刷新节点、索引别名等元数据信息。",
  "cluster.manage.metadata_configs.tips.cluster_settings_check": "定时获取并同步集群设置（如 transient/persistent settings）。",
  ...
  "cluster.regist.step.connect.label.agent_credential": "选择探针凭据",
  ...
  "cluster.regist.form.verify.required.agent_credential": "请选择探针凭据！",
