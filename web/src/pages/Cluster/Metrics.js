...
import { PartialTheme ,Chart, Axis, BarSeries, Position, ScaleType,LineSeries,CurveType,niceTimeFormatByDay, Settings, timeFormatter  } from "@elastic/charts";
import styles from './Metrics.less';

const KIBANA_METRICS = {
    metrics: {
        kibana_os_load: [
            {
      ...
      // </Menu> */}
        ...
        return (
            <div>
                ...
                {
                    Object.keys(Elasticsearch_METRICS.metrics).map((e, i) => {
                        let axis=Elasticsearch_METRICS.metrics[e].axis
                        let lines=Elasticsearch_METRICS.metrics[e].lines
