...
export default ({sourceCluster={}, targetCluster={}, range={}})=>{
  ...
  return <div>
    ...
    <div className="metric-item">
      <div className="title">{formatMessage({id:"migration.title.metrics.target_search_qps"})}</div>
      <div className="body">
        <WidgetLoader 
          id="cji1sc28go5i051pl1i1"
          range={range}
    ...
    <div className="metric-item">
      <div className="title">{formatMessage({id:"migration.title.metrics.target_search_latency"})}</div>
      <div className="body">
        <WidgetLoader 
          id="cji1sc28go5i051pl1i2"
          range={range}
