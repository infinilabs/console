...
const useAutoFontSize = (target, _container, height, width, ratio) => {
...
const AutoFontSizer = ({ children, target, height, width, ratio = CHILD_SIZE_RATIO }: Props) => {
  const _container = useRef<HTMLElement | undefined>();
  const fontSize = useAutoFontSize(target, _container, height, width, ratio);
