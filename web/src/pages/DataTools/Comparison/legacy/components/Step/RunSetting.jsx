    ...
    >
      <Form.Item
        label={
          ...
          >
            {formatMessage({ id: "migration.setting.dump_setting" })}
          </span>
        }
      ></Form.Item>
      ...
      <Form.Item label={formatMessage({ id: "migration.setting.partitions" })}>
        {getFieldDecorator("settings.dump.partition_size", {
          initialValue: stepData?.settings?.dump?.partition_size || 1,
          rules: [
            {
              required: true,
              message: formatMessage({ id: "migration.validation.partition_size" }),
            },
          ],
        })(<InputNumber style={{ width: "100%" }} min={1} />)}
      </Form.Item>
      <ExecuteNodes
        ...
        form={form}
      />
      <Form.Item label={formatMessage({ id: "migration.setting.detect_incremental_data" })}>
