...
import styles from "../../Detail/MigrateIndices/index.scss";
...
export const FirstStep = (props) => {
    ...
    return [
      {
        ...
        render: (value, record) => {
          if (record.targetDocuments > 0) {
            return (
              <Tooltip title={formatMessage({ id: "migration.warning.target_index_exists" })}>
                <Icon
                  type="warning"
                  theme="filled"
      ...
      if (cIndex !== -1) {
        ...
        cColumn.render = (value, record) => (
          <IndexEditor
            ...
            indices={Object.values(targetIndicesMap)}
          />
        );
      }
  ...
  return (
    <Form {...formItemLayout} layout={"horizontal"}>
      ...
      >
        <Col span={11}>
          <Card size="small" title={formatMessage({ id: "migration.label.source_cluster" })}>
            <SelectCluster
        ...
        <Col span={11}>
          <Card size="small" title={formatMessage({ id: "migration.label.target_cluster" })}>
            <SelectCluster
