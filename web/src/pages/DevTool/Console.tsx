import Console from "../../components/vendor/console/components/Console";
...
import { setClusterID } from "../../components/vendor/console/modules/mappings/mappings";
            ...
            <TabPane
              tab={
                <TabTitle
                  ...
                  distribution={clusterMap[pane.cluster_id]?.distribution}
                />
              }
              key={pane.key}
